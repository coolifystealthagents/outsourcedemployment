...
const researchPostsRaw: ResearchPost[] = [
  ...
  { slug: 'philippines-onboarding-records-coordination-research', title: 'Philippines Onboarding Records Coordination: Completeness Without Employment Decisions', excerpt: 'Research the evidence needed for an onboarding coordinator to prepare a clean handoff while HR retains decision rights.', publishedDate: '2026-08-12', body: researchBodyV3('What can onboarding records coordination prove before an HR owner confirms a new hire is ready?', 'The ILO publishes guidance on working conditions and labour standards, which helps frame questions but does not certify a specific hiring arrangement.', 'a coordinator can track approved documents, account requests, orientation attendance, and open questions against a named owner and start-date plan.', 'use sanitized packets with a missing document, conflicting identity field, delayed account request, and an ordinary complete case.', 'the role must not change employment terms, decide eligibility, answer policy questions beyond approved wording, or grant access without authorization.', [researchSources[3], researchSources[4], researchSources[5]]) },
