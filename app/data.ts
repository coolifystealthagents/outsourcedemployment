...
export const allBlogPosts = [...september7BlogBatch, ...september4BlogBatch, ...september3BlogBatch, ...september2BlogBatch, ...september1BlogBatch, ...august31BlogBatch, ...august23BlogBatch, ...august21BlogBatch, ...august20BlogRepairBatch, ...august19Repair3Batch, ...august18Repair5Batch, ...august17BlogBatch, ...august14BlogBatch, ...august13BlogBatch, ...august11BlogBatch, ...dailyBlogBatch.slice(22), ...blogPosts, ...dailyBlogBatch.slice(0, 22)];
...
const researchPostsRaw: ResearchPost[] = [
  ...
  { slug: 'philippines-leave-records-reconciliation-research', title: 'Philippines Leave Records Reconciliation: Separating Facts from Approval', excerpt: 'Use evidence-led reconciliation to prepare leave records without letting a support role decide entitlement or exceptions.', publishedDate: '2026-08-12', body: researchBodyV3('How can leave-record reconciliation surface mismatches without turning a coordinator into the approver?', 'The ILO working-conditions resource is a useful starting point for labour standards questions, but it does not replace advice tied to the employer and location.', 'a coordinator can compare approved requests, recorded balances, dates, and supporting notes, then route an exception with its source records.', 'test cases with one overlapping request, one missing approval, one corrected date, and one record that should be escalated.', 'the role cannot approve leave, interpret entitlement, change balances without authorization, or decide how a dispute should be resolved.', [researchSources[3], researchSources[7]]) },
