...
import { august19BlogBatch } from './blog/aug19-batch';
...
export const allBlogPosts = [...august19BlogBatch, ...august17BlogBatch, ...august14BlogBatch, ...august13BlogBatch, ...august11BlogBatch, ...dailyBlogBatch.slice(22), ...blogPosts, ...dailyBlogBatch.slice(0, 22)];
