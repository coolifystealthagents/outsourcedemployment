...
const researchPostsRaw: ResearchPost[] = [
  ...
  { slug: 'philippines-candidate-scheduling-evidence-research', title: 'Philippines Candidate Scheduling Evidence: Coordination Before Selection', excerpt: 'Assess scheduling and application-completeness work without outsourcing hiring judgment or candidate decisions.', publishedDate: '2026-08-12', body: researchBodyV3('Which recruiting coordination outputs help a hiring owner decide without hiding gaps in the candidate record?', 'The IRS explains that worker classification depends on the actual relationship, including control and independence, rather than a label alone.', 'a coordinator can schedule approved interview steps, check required fields, preserve structured notes, and flag missing evidence.', 'test a sanitized queue with a timezone conflict, incomplete application, duplicate candidate, and a clear reschedule request.', 'the role must not rank candidates, reject applicants, set compensation, interpret qualifications, or make a hiring promise.', [researchSources[8], researchSources[3]]) },
