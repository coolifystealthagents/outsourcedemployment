  ...
  return <>
    ...
    <main className="section rich-article-page">
      ...
      <article className="container article-wrap evidence-article" data-article-marker="philippines-hr-records-access-2026">
        ...
        <p className="article-date"><time dateTime={publishedDate}>Published {formatReaderDate(publishedDate)}</time> · Reviewed <time dateTime={article.updated}>{formatReaderDate(article.updated)}</time> · Evidence checked against the numbered sources below.</p>
