    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Employment planning office</p>
          <h1>Outsourced Employment: an employment memo for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced employment guide for leaders comparing outsourced employment, staffing, and remote team models. The page now uses a distinct professional consulting layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>memo blocks and hiring steps</figcaption></figure>
      </div>
    </section>
